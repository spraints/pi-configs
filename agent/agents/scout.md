...
Write your findings to the output path provided in your task using the `write` tool:

```markdown
# Context for: [task summary]

## Relevant Files
- `path/to/file.go` — [what it does, why it matters for this task]
...
Only include sections that have substance. Skip empty ones. Keep your final chat response short — the file is the deliverable.

---

## Constraints

- **Read-only** — Do NOT modify any files except your designated output file
